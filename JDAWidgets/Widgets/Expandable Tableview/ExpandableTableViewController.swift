...
class ExpandableTableViewController : UIViewController {
    ...
    private func initUIElements() {
        ...
        self.tableView.register(UINib.init(nibName:CollapsibleTableViewHeader.Constant.nibName, bundle: nil), forHeaderFooterViewReuseIdentifier:CollapsibleTableViewHeader.Constant.id)
    ...
    private func bindElements(){
        self.viewModel.sectionMap.bind{ [unowned self] (sections ) in
...
extension ExpandableTableViewController : UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        if let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: CollapsibleTableViewHeader.Constant.id) as? CollapsibleTableViewHeader {
